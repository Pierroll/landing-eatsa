...
import { manifest } from './manifest_BLuJgsZj.mjs';
...
const _page7 = () => import('./pages/api/productos.astro.mjs');
const _page8 = () => import('./pages/robots.txt.astro.mjs');
const _page9 = () => import('./pages/_lang_/404.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/api/productos.ts", _page7],
    ["src/pages/robots.txt.ts", _page8],
    ["src/pages/[lang]/404.astro", _page9],
